...
namespace TravelAccommodations.Controllers
{
    ...
    public class CommentController : Controller
    {
        ...
        public CommentController(ICommentRepository service)
        {
            _service = service;
        }
        ...
        {
            Comment comment = await _service.getAsync(id);
            return comment.ToViewModel();
        }


        [HttpPost("Create")]
        public async Task<StatusCodeResult> Create([FromBody]CommentViewModel viewModel)
        {
        ...
        [HttpPut("Update")]
        public async Task<StatusCodeResult> Update([FromBody]CommentViewModel viewModel)
        {
