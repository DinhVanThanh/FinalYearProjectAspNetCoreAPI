...
namespace TravelAccommodations.Controllers
{
    ...
    public class ServiceController : Controller
    {
        ...
        [HttpGet("{id}")]
        public async Task<ServiceViewModel> Get(int id)
        {
            Service service = await _service.getAsync(id);
        ...
        [HttpPut("Update")]
        public async Task<StatusCodeResult> Update([FromBody]ServiceViewModel viewModel)
        {
